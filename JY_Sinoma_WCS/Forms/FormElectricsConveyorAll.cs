...
{
    public partial class FormElectricsConveyorAll : Form
    {
        private ElectricsConveyorAll electricsConveyor;

        SystemStatus systemstatus;
        public ConnectPool dbConn;
        public int index;
        public FormElectricsConveyorAll(ElectricsConveyorAll electric, int nIndex, SystemStatus systemStatus)
        {
            InitializeComponent();
            index = nIndex;
