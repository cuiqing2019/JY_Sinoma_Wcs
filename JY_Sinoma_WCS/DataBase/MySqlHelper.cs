...
namespace DataBase
{
    ...
    public sealed class MySqlHelper
    {
        ...
        public static string SystemSeqString = ConfigurationSettings.AppSettings["SystemSeq"];
        ...
        {
            using (MySqlConnection connection = new MySqlConnection(LocalConnectionString))
            {
        ...
        /// <summary>
        /// Execute a MySqlCommand or a stored procedure with parameters,use the exists ConnectionString
        /// </summary>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="MySqlParameters">An array of OracleParamters used to execute the command</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
        public static int ExecuteNonQuery(CommandType commandType, string commandText,MySqlParameter[] MySqlParameters)
        {
            return ExecuteNonQuery(LocalConnectionString, commandType, commandText, MySqlParameters);
        }
        ...
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="MySqlParameter">A OracleParamter used to execute the command</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
        public static int ExecuteNonQuery(CommandType commandType, string commandText,MySqlParameter mysqlParameter)
        {
            return ExecuteNonQuery(commandType, commandText, new MySqlParameter[] { mysqlParameter });
        }

        /// <summary>
        /// Execute a MySqlCommand or a stored procedure with no parameters,use the exists ConnectionString
        /// </summary>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <returns>An int representing the number of rows affected by the command</returns>
        ...
        /// <param name="MySqlParameters">An array of OracleParamters used to execute the command</param>
        /// <returns>A dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDataset(CommandType commandType, string commandText, MySqlParameter[] MySqlParameters)
        {
            return ExecuteDataset(LocalConnectionString, commandType, commandText, MySqlParameters);
        }

        /// <summary>
        /// Execute a MySqlCommand or a stored procedure with a parameter,use the exists ConnectionString
        /// </summary>
        /// <param name="commandType">The CommandType (stored procedure, text, etc.)</param>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="MySqlParameter">A OracleParamter used to execute the command</param>
        /// <returns>A dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDataset(CommandType commandType, string commandText, MySqlParameter MySqlParameter)
        {
            return ExecuteDataset(commandType, commandText, new MySqlParameter[] { MySqlParameter });
        }
        ...
        /// <param name="commandParameters">An array of OracleParamters used to execute the command</param>
        /// <returns>A MySqlDataReader containing the resultset generated by the command</returns>
        public static MySqlDataReader ExecuteReader(CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
        ...
        /// <returns>A MySqlDataReader containing the resultset generated by the command</returns>
        public static MySqlDataReader ExecuteReader(CommandType commandType, string commandText, MySqlParameter commandParameter)
        {
            return ExecuteReader(commandType, commandText, new MySqlParameter[] { commandParameter });
        }
        ...
        /// <param name="commandParameters">An array of OracleParamters used to execute the command</param>
        /// <returns>An object containing the value in the 1x1 resultset generated by the command</returns>
        public static object ExecuteScalar(CommandType commandType, string commandText, MySqlParameter[] commandParameters)
        {
        ...
        /// <param name="commandParameter">A OracleParamter used to execute the command</param>
        /// <returns>An object containing the value in the 1x1 resultset generated by the command</returns>
        public static object ExecuteScalar(CommandType commandType, string commandText, MySqlParameter commandParameter)
        {
            return ExecuteScalar(commandType, commandText, new MySqlParameter[] { commandParameter });
        }
		...
		*/
        ...
        public static void RollbackTransaction(MySqlTransaction tran)
        {
            tran.Rollback();
        ...
        /// <param name="modeData">sql语句的操作类型</param>
        /// <returns></returns>
        public static string MangerDataSet(MySqlParameter[] myParmas, string sqlStr, DataSet tableName, string modeData)
        {

            string errText = string.Empty;
            using (MySqlConnection con = new MySqlConnection(MySqlHelper.LocalConnectionString))
            {

                con.Open();

                MySqlCommand cmmandOralce = con.CreateCommand();
                cmmandOralce.CommandText = sqlStr;
                foreach (MySqlParameter parame in myParmas)
                {
        ...
        /// </summary>
        /// <returns></returns>
        public static string CanConnectDb()
        {
            string errText = string.Empty;
            using (MySqlConnection conn = new MySqlConnection(MySqlHelper.LocalConnectionString))
            {
                try
                {
                    conn.Open();
                ...
                {
                    errText = "数据库连接没有成功" + ex.Message.ToString().Trim();
                }
        ...
        public static bool CanConnectDb(bool notuse)
        {
            bool sucess;
            using (MySqlConnection conn = new MySqlConnection(MySqlHelper.LocalConnectionString))
            {
